...
class QuizInterface:
    def __init__(self, quiz_brain:QuizBrain):
        ...
        self.score_txt = Label(text="Score: 0",highlightthickness=0,bg=THEME_COLOR,fg="white")
        ...
        self.right_btn = Button(image=right_btn_img, highlightthickness=0,command=self.true_pressed)
    ...
    def true_pressed(self):
        ...
        self._give_feedback(is_right)

    def false_pressed(self):
        is_right = self.quiz.check_answer("False")
        self._give_feedback(is_right)

    def _give_feedback(self,is_right):
        if is_right:
